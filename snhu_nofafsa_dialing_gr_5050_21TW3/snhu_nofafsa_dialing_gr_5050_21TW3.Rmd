...
+ __Reg Rate:__ The InPopulation to reg rate (# of regs / # of InPopulation) was nearly flat at **0.1 percentage points lower** for the test group versus the control. Out of those that completed a FAFSA, the reg rate was **0.3 percentage points higher** for the test group versus the control. Neither of these differences is statistically significant.


```{r echo=FALSE, out.width = "80%", fig.align='center'}
knitr::include_graphics(here::here("imgs/nofafsa_21TW3_overall_20210222.png", ""))
```
...
+ __Wrong FAFSA:__ Do we need this?? Those that originally submitted the wrong FAFSA (filled out 21-22 instead of 20-21) completed a FAFSA at nearly twice the rate, but there was no difference between test and control groups.
